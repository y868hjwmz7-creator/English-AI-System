...
--
-- 【これは何か】
--   0027 だけです。0026 までは、すでに実行済みのはずです。
--   中身は GitHub の supabase/migrations/0027_learning_state.sql と同じで、
--   **新しいことは何もしていません。**
--
-- 【何が起きるか】
--   単語帳の状態が **2つ → 3つ**になります。
--
--     まだ      … 意味が出てこない        → 箱 0 に戻し、翌日また出す
--     覚えかけ  … 出てくるが自信がない    → 箱は 3 で止め、1 / 2 / 4 日後
--     覚えた    … すぐ出てくる            → 1 / 2 / 4 / 7 / 14 / 30 日後
--
--   復習は「**まだ → 覚えかけ**」の順に出るようになります。
--
--   これまで画面に出していた「覚えかけ」の数は、中身が「まだ」の数でした。
--   **言葉と中身が食い違っていた**ので、そろえます。
--
-- 【どこまで影響するか】
--   ・**いま入っている語は1件も変わりません。** 状態も箱も日付もそのまま
--   ・教材・宿題・取り組みには**いっさい触れません**
--   ・広げる方向の変更なので、いまの行が新しい決まりに反することはありません
--
-- 【何度貼っても安全です】
