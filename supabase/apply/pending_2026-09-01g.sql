...
--
-- 【これは何か】
--   0026 から 0031 までの6つを、**正しい順番でまとめた**ものです。
--   中身は GitHub の supabase/migrations/ にある同じ名前のファイルと
--   まったく同じで、**新しいことは何もしていません。**
--
--   1つずつ貼ると順番を間違えやすく、どこまで貼ったかも分からなく
--   なるので、1つにまとめました。
--   **すでに入っているものは飛ばされます。**
--
-- 【何が起きるか】
--   ① 0026 … スコアの入力に範囲を付ける(TOEIC 100〜990 / VERSANT 10〜90)
--   ② 0027 … 単語帳に「覚えかけ」が加わります
--             (「覚えかけ」を押すと断られるのは、これが理由です)
