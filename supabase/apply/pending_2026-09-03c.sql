...
--
-- 【これは何か】
--   0037 の1つだけです。GitHub の
--   supabase/migrations/0037_meeting_kind.sql と**まったく同じ**中身です。
--
-- 【先に貼っていただくもの】
--   まだでしたら pending_2026-09-02c.sql → pending_2026-09-03.sql →
--   pending_2026-09-03b.sql → これ、の順に貼ってください。
--   順番を間違えても壊れませんが、02c を貼るまでは教材を発行できません。
--
-- 【これは窓口(Edge Function)の置き直しが要りません】
--   会議の中身は会話とまったく同じなので、`generate-material` は
--   そのままで動きます。**貼るだけで使えるようになります。**
--
-- 【うまくいかないとき】
