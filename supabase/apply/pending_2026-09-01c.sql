...
--
-- 【これは何か】
--   0028 だけです。0027 までは、すでに実行済みのはずです。
--   中身は GitHub の supabase/migrations/0028_wordbook_facets.sql と同じです。
--
-- 【何が起きるか】
--   単語帳を **分野(業界・趣味)** と **場面・話題** でも絞れるようになります。
--   語が「どの教材で出会ったか」はすでに記録されているので、
--   その教材の分野・場面を**一緒に返すようにするだけ**です。
--
-- 【どこまで影響するか】
--   ・**いま入っている語は1件も変わりません。** 読み取るだけです
