...
|---|---|---|---|---|
| Pre-Basic | 3〜6語 | be動詞、現在形。**接続詞を使わない。1文1節。** | 最頻 500語 | 1〜2文 |
| Basic | 4〜8語 | 現在進行形、can、命令文、and で2つまで | 最頻 750語 | 1〜2文 |
| A1 | 5〜10語 | 規則変化の過去形、be going to、but / because | 最頻 1,000語 | 2〜3文 |
| A1+ | 6〜12語 | 不規則過去、will、have to、比較級 | 最頻 1,500語 | 2〜3文 |
| A2 | 8〜14語 | 現在完了(経験)、to不定詞、動名詞、when / if | 最頻 2,000語 | 3〜4文 |
| A2+ | 10〜16語 | 受動態、関係代名詞(who / that)、should / might | 最頻 2,500語 | 3〜4文 |
| B1 | 12〜18語 | 現在完了進行形、関係詞、間接話法、仮定法(第2) | 最頻 3,500語 | 3〜5文 |
| B1+ | 14〜20語 | 過去完了、仮定法(第3)、句動詞、分詞の後置修飾 | 最頻 5,000語 | 3〜5文 |
| B2 | 16〜24語 | 名詞化、複雑な関係詞、however / whereas などの談話標識 | 最頻 7,000語 | 4〜6文 |
| B2+ | 18〜26語 | 婉曲、含み、抽象的な議論、節を2つ重ねる | 最頻 9,000語 | 4〜6文 |
| C1 | 20〜30語 | 埋め込み節を重ねる、倒置、慣用表現、皮肉・含み | 低頻度語も可 | 4〜6文 |
| C1+ | 20〜32語 | 専門的な議論、レジスターの切り替え、比喩 | 分野の専門語も可 | 4〜6文 |
| C2 | 制限しない | 文体を意図して操作する。ネイティブ向けの文章 | 制限しない | 4〜6文 |
| Proficiency | 制限しない | C2 に加えて、文化的な前提を含む言い回し | 制限しない | 4〜6文 |
