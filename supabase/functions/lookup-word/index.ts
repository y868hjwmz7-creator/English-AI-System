...
1. **意味を1〜3件返す。** そして
   ...
   **ただし、意味は渡された語句そのものの意味に限る。**
   文は「どの意味で使われているか」を選ぶためだけに読む。
   **文にあって語句に無いものを、意味に持ち込まない**
   (否定・主語・時・疑問・受け身・助動詞)。

   例: 「Nobody expected it to matter.」の expected it to matter は
   **「重要だと思う・大事だと思う」**である。
   **「予想していなかった」は誤り** ——
   否定は Nobody のものであって、語句のものではない。

   例: 「It wasn't easy at all.」の easy は **「やさしい・簡単な」**である。
   **「難しい」は誤り。**

   例: 「Did he agree?」の agree は **「同意する」**である。
   **「同意したのか」は誤り**(疑問は文のものである)。

   この意味は**単語帳の出題にそのまま出る。** 文から切り離して
   1つずつ出すので、文の否定や主語が混ざっていると
   **英語と日本語が食い違った問題になる**(2026-09-26 実機・利用者の指摘)
