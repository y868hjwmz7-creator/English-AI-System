 ...
 *
 * **値は、利用者の耳が決めたものである。** 22手めで
 * 「次の文の音がいまだに入ります」と言われて 0.12 まで上げた ——
 * あれは**会話の教材**の話で、いま分かっているとおり
 * **境目のずれ以外の出どころが無い**(遅れは実測 0・`REPEAT_LEAD` の節)。
 * だから**まるごとここへ移す。**
 *
 * **信じられない教材の折り返しは、24手めの前と1ミリ秒も変わらない。**
 * 変わるのは**控えが正しい教材だけ**で、そこは 0 になる。
 */
export const SLIP = 0.12
