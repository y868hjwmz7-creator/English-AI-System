 ...
 */
/* **札は「英語だけ」**(第5.253節・2026-09-23 利用者の指定)。

   もとは「英語だけ、くり返し」。帯のプルダウンは狭く、
   **「日本語→英語」と同じく切れる**(あちらは「言う練…」まで縮んでいた)。
   **利用者が呼んでいるとおりに書く** ——
   「残る二つは英語だけの聞き流し、そして日本語→英語」。

   **くり返すことは、聞けば分かる**(同じ英語が2回鳴る)。
   札で説明しない(共通ルール「余計な説明書きは全て排除」)。 */
const MODE_EN = { id: 'en', label: '英語だけ' }
...
/* **札は「日本語→英語」**(第5.253節・2026-09-23 利用者の指定)。

     > 普通に日本語→英語で良いです

   もとは「言う練習(間 → 答え)」。**帯の欄に入りきらず、
   スマホでは「言う練…」と切れていた**(利用者の写真)。
   **何が鳴るかを、そのまま書く**のがいちばん短い。 */
const MODE_SAY = { id: 'say', label: '日本語→英語' }
/* ══════════════════════════════════════════════════════════════════
