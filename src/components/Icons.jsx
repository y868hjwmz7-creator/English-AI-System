 ...
 *   ・**3つのつまみは、わざと位置をずらす。** そろえると「三本線」に見え、
 *     第5.262節で言われた運動靴の印に戻ってしまう
 *
  ...
  return (
    <svg className={className} viewBox="0 0 20 20" aria-hidden="true" focusable="false">
      ...
      <g fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round">
        ...
        <path d="M2.4 4.3h1.2" />
        <path d="M11.6 4.3h6" />
        <circle cx="7.6" cy="4.3" r="1.9" />
        {/* 2段目(つまみは右より) */}
        <path d="M2.4 10h6" />
        <path d="M16.4 10h1.2" />
        <circle cx="12.4" cy="10" r="1.9" />
        {/* 3段目(つまみはまん中より少し右) */}
        <path d="M2.4 15.7h3.2" />
        <path d="M13.6 15.7h4" />
        <circle cx="9.6" cy="15.7" r="1.9" />
      </g>
    </svg>
  )
}
