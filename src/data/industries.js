...
export const INDUSTRIES = [
  ...
  /* VAT還付代行(2026-09 利用者の指定)。
     日本企業が海外の出張・展示会・仕入れで払った付加価値税(VAT)を、
     その国の税務当局へ**代わりに**還付申請する会社。

     **「監査」や「金融」の下に入れない。** あちらは数字を調べる・お金を
     動かす仕事だが、こちらは**各国の役所を相手に、書類を集めて期限内に
     出し切る**仕事である。使う言葉がまるごと違う(還付・領収書の原本・
     税務代理人・非居住者・第13指令 …)。
     **英語そのものが道具**になる仕事でもある — 相手の役所も取引先も海外。

     名前は業界でそのまま使われている「VAT還付代行」にした。
     正式には「海外付加価値税(VAT)還付の代行」だが、
     **札や教材名に出る名前は短いほうがよい**(折り返すと読めなくなる) */
  { id: 'vatrefund',     label: 'VAT還付代行',  hint: '海外で払った付加価値税(VAT)の還付申請を代行する。各国の税務当局、書類集め、期限' },
