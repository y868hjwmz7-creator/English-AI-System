...
export const INDUSTRIES = [
  ...
  /* 格闘技(2026-09 利用者の指定「格闘技には、MMAとボクシングを」)。
     ...
     はじめは格闘技を**1つめの欄に出す分野へ上げ**、MMA とボクシングを
     その種類として並べていた(**種類を持てるのは2段まで**なので、
     格闘技がスポーツの種類のままでは下に置けなかった)。

     **2026-09 の指定で、3つをスポーツの中へ入れ直した。**

       > 「趣味」→「スポーツ」の中に「MMA」「ボクシング」「柔術」を
       > 追加してください

     **格闘技そのものは、1つめの欄に残してある。** 種類を持たなくなった
     だけで、**選べなくなってはいない**(「一度入れた趣味を勝手に
     減らさない」・CLAUDE.md)。「MMA でもボクシングでもない格闘技」も
     ここで選べるし、この id で作った教材の名前もこれまでどおり出る。 */
  { id: 'martial',  group: 'hobby', label: '格闘技', hint: '道場やジムでのやりとり、技の名前、スパーリング、大会' },
  /* **id は変えない。** 変えると、その id で作った教材の名前が出なくなる。
     親だけを `martial` から `sports_fun` へ移した */
  { id: 'mma',      group: 'hobby', parent: 'sports_fun', short: 'MMA', label: 'MMA(総合格闘技)', hint: '打撃と組みの切り替え、ケージ、階級、試合の組まれ方' },
  { id: 'boxing',   group: 'hobby', parent: 'sports_fun', short: 'ボクシング', label: 'ボクシング', hint: 'ミット打ち、フットワーク、階級、計量、試合運び' },
  /* 柔術(2026-09 利用者の指定で追加)。**打撃が無く、寝技が中心**なので、
     MMA ともボクシングとも出てくる語がまるごと違う(ガード、パス、
     サブミッション、帯、オープンマット)。だから同じ種類にはしない */
  { id: 'jiujitsu', group: 'hobby', parent: 'sports_fun', short: '柔術', label: '柔術(ブラジリアン柔術)', hint: 'ガード、パスガード、極め技、帯、オープンマット、大会' },
