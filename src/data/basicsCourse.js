 ...
 *   > コンセプトはコミュニケーションのため。
 *
 * **呼び名は「基本360語」「標準1200語」**(2026-09 利用者の指定で改めた)。
 *
 ...
 * すでに `course_days` に残っている行の値でもある。
 * **呼び名だけを変える**(「スピーチ練習」で `pronunciation` を
 * 変えなかったのと、まったく同じ考え方)。
 *
...
export const COURSE_TIERS = [
  {
    ...
    label: '基本360語',
    ja: 'まず、これだけ',
    hint: '1日 12 語。話すために本当に要る語だけを選んである',
    levels: ['Pre-Basic'],
  },
  {
    id: 'full',
