 ...
 * ========================================================================== */
{
  ...
  /* **「やったもの」の見出しも出さない**(2026-09 利用者の指定)。
     カードの1行目が日付と「やった」の札で名乗っている。
     **カードそのものは消していない**(消すと、やった宿題に戻れない) */
  ok(!/'やったもの'/.test(hw) && !/やったもの\(/.test(hw),
    '今週の宿題 … 「やったもの」の見出しを出していない')
  ok(/id: 'done', label: null, list: done/.test(hw),
    '今週の宿題 … やったもののカードは、これまでどおり並んでいる')
