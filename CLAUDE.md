...
- `supabase/test/rls_test.sql` — トレーナー1人・生徒2人を作り、
  「誰に何が見え、何ができないか」を確かめる。**拒否されるべき操作が通ったら失敗する**

この検証は実際に重大な穴(生徒が自分をトレーナーに昇格できる)を見つけた実績がある。
省略しないこと。
...
**トレーナー約50人・1人あたり生徒30人(全体で生徒約1,500人)。**
