...
> **現在地（2026-08-24）**: 開発者本人は**個人事業主で、古物商許可は未取得**。
> したがって α 検証は **MY STUFF（自分の持ち物の売却）から始め**、
> HUNT の実地検証は許可取得後に回す。開発そのものは止めない。
> 詳細は [11-SETUP-CHECKLIST.md](11-SETUP-CHECKLIST.md) §2。
>
> `要確認`: 「自分の持ち物の売却」が古物営業に当たらないという理解自体を、
> 管轄の警察署で確認すること。**この確認が最初のタスクである。**

### L-0b. 事業主体 — **確定: 個人事業主**（2026-08-24）

| 依存する手続き | 状態 |
|---|---|
| 古物商許可の申請主体 | **未取得**（申請はこれから） |
| Marketplace API の開発者登録 | 未登録 |
| App Store / Google Play の開発者アカウント | 未登録 |
| 特定商取引法に基づく表記 | 未作成 |
| 配送会社との契約 | 未着手 |
| プライバシーポリシーの事業者名 | 未作成 |

**段取りと着手順序は [11-SETUP-CHECKLIST.md](11-SETUP-CHECKLIST.md) にまとめた。**

`要確認`（個人事業主特有の論点）: 特定商取引法に基づく表記では
氏名・住所・電話番号の記載が原則とされる。個人事業主にとって実務的な負担になるため、
**課金を実装する前に**表記の方法を弁護士に確認すること。
