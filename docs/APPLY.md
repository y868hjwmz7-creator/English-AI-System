...
## 「やったかどうか」は、アプリが言う(2026-09)

**覚えておかなくてよい。** トレーナー・管理者でログインすると、
**まだ済んでいないことがあるときだけ**、画面のいちばん上に出る。

    あと 2 つ、Supabase でやることが残っています
      ① 貼る SQL が、まだ最後まで届いていません      [貼るものを開く]
      ② 教材の窓口(generate-material)が、まだ…       [貼るものを開く]

- **済んでいれば、何も出ない。** 出ていなければ、それが「済んでいる」印である
- **確かめるのに、教材も音声も作らない**(1円もかからない)
- 済ませたら、その帯の**「済ませたので、確かめ直す」**を押す
- もっと細かく見たいときは、これまでどおり `check.sql`(下の表)を貼る

> **こちらからは確かめられない。** この環境から Supabase には届かないので、
> 「何が要るか」は分かっても「何が済んだか」は分からない。だから
> **アプリに訊かせている**(`src/lib/setupState.js`)。
...
| **★いま貼っていただくもの … 0041〜0058 を全部まとめたもの** | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_matome.sql` |
...
| (参考)0052 30日講座の進み具合だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-13.sql` |
| (参考)0051 文法解説(SVOC)だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-12.sql` |
| (参考)0050 苦手タグの文法項目だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-11.sql` |
| (参考)0047 単語 / フレーズをまとめるところだけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-10.sql` |
| (参考)0045 想定される質問だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-09.sql` |
| (参考)0044 教材を消すだけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-08.sql` |
| (参考)0043 Speech練習だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-07.sql` |
| (参考)0042 続けた記録と週の目標だけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-06.sql` |
| (参考)0041 ゲストの記録をまとめて消すだけ | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/apply/pending_2026-09-05.sql` |
...
| **★いま置き直していただくもの … 教材を作る関数**(業種べつの単語帳を、場面べつではなく1冊 200 語で作れるようにしました) | `https://github.com/y868hjwmz7-creator/English-AI-System/blob/claude/project-spec-document-k5wmwy/supabase/functions/generate-material/index.ts` |
